...
ELGENESIS_TIME_HEX=$(printf "0x%x" $ELGENESIS_TIME)
...
echo "ELGENESIS_TIME=$ELGENESIS_TIME GENESIS_TIME=$GENESIS_TIME PRAGUE_TIME=$PRAGUE_TIME"

sedPatten="/timestamp/c\    \"timestamp\":\"$ELGENESIS_TIME_HEX\","
echo $sedPatten
